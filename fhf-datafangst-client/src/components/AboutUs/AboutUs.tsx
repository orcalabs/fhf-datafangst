  ...
  return (
    ...
    >
      ...
      <Typography>
        ...
        Fiskeri- og havbruksnæringens forskningsfinansiering (FHF). Prosjektet
        har som mål å utrede og utvikle en digital plattform for fangstanalyse
        og bærekraftsrapportering innenfor fiskeri.
      </Typography>
      <Typography>
        Applikasjonen er en pilot-tjeneste under utvikling og vil dermed kunne
        inneholde ufullstendig funksjonalitet, feil eller ha nedetid. Spørsmål
        eller tilbakemeldinger kan sendes til e-post under.
      </Typography>
      <Box>
